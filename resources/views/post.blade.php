    ...
    <div class="bg-gray-100 p-6 rounded-2xl mt-2">
        <form>
            ...
            <div class="relative">
                ...
                <input type="Comment" id="Comment" class="block w-full p-4 pl-5 text-sm focus:ring-blue-500 focus:border-blue-500 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-2xl" placeholder="Add your comment here!" maxlength="150" required>
