    ...
    <div class="bg-gray-100 p-6 rounded-2xl mt-2">
        <form>
            ...
            <div class="relative">
                ...
                <input type="Comment" id="Comment" class="block w-full p-4 pl-5 focus:ring-blue-700 focus:border-blue-700 rounded-2xl" placeholder="Add your comment here!" maxlength="150" required>
